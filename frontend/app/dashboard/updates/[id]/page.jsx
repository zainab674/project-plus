...
const page = ({ params }) => {
    ...
    const handleUpdatesRequest = useCallback(async (e) => {
        ...
        try {
            ...
            const res = await giveUpdateRequest(submitData);
            toast.success(res.data?.message);
            setFormdata({
                message: '',
                project_client_id: id,
    ...
    const handleInternalDocSelect = (doc) => {
        ...
        setFormdata(prev => ({ ...prev, file: undefined })); // Clear PC file when internal doc is selected
    };
                                ...
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg text-gray-600 mt-2">
                                            {user?.Role === "PROVIDER" || user?.Role === "TEAM" ? "Share updates and communicate with clients" : "Stay informed about your project progress"}
                                        </p>
