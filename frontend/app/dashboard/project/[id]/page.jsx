...
import { Plus, User, Calendar, FileText, ChevronRight, MoreVertical, UserPlus, Users, Mail, FileIcon, Image, Menu, X, ArrowBigLeft, ArrowLeft, AlertCircle, Ellipsis, Users2, MailPlus, Link, Trash2, Play } from 'lucide-react';
              ...
              {user?.Role !== "CLIENT" && (
                <>
                  <button
                    ...
                    className="bg-white hover:bg-slate-50 border border-slate-500 text-slate-700 px-3 py-1.5 rounded-md text-xs font-medium transition-colors"
                  >
                    Edit Case
                  </button>
                  {project?.status !== 'Active' && (
                    <button
                      ...
                      className="bg-green-600 hover:bg-green-700 text-white px-3 py-1.5 rounded-md text-xs font-medium transition-colors flex items-center gap-1.5 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                  ...
                  {project?.status === 'Active' && (
                    <div className="bg-green-100 text-green-800 px-3 py-1.5 rounded-md text-xs font-medium flex items-center gap-1.5">
                  ...
                  {user?.Role !== "CLIENT" && (
                    ...
                    <button
                      ...
                      className="bg-red-600 hover:bg-red-700 text-white px-3 py-1.5 rounded-md text-xs font-medium transition-colors flex items-center gap-1.5"
                    >
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild className="hover:bg-transparent text-black">
                      <button className="mt-2 cursor-pointer px-3 py-1.5 rounded-md text-xs font-medium border border-black">More Actions</button>
                    </DropdownMenuTrigger>
                    <DropdownMenuContent className="w-56 mr-2 mt-2 bg-white border-primary">
                      <DropdownMenuGroup>
                        ...
                        <DropdownMenuItem
                          className="cursor-pointer text-black hover:!bg-tbutton-bg hover:!text-tbutton-text"
                          onClick={() => router.push(`/dashboard/meeting/create?scheduled=true&project=${project?.project_id}`)}
                        >
                        ...
                        <DropdownMenuItem
                          className="cursor-pointer text-black hover:!bg-tbutton-bg hover:!text-tbutton-text"
                          onClick={() => router.push(`/dashboard/meeting/create-client?scheduled=true&project=${project?.project_id}`)}
                        >
                          <Calendar className="mr-2 h-4 w-4" />
