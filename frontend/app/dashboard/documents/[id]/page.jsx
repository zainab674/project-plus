...
//                         <h1 className="text-3xl font-semibold text-black">Projects Documents</h1>
...
//                                                             <SelectGroup>
//                                                                 <SelectLabel className="text-black">Status</SelectLabel>
...
//                                                 user?.Role == "CLIENT" &&
//                                                 (
//                                                     <span className="text-black">{document.status}</span>
//                                                 )
//                                             }
//                                         </TableCell>
...
const page = ({ params }) => {
    ...
    const handleDocumentRequest = useCallback(async (e) => {
        ...
        try {
            const res = await requestDocuemtnRequest(formdata);
            toast.success(res.data?.message);
            setFormdata({ name: '', description: '', project_client_id: id });
        } catch (error) {
            toast.error(error?.response?.data?.message || error?.message);
        } finally {
            setOpen(false);
    ...
    const stats = {
        ...
        uploaded: documents.filter(doc => doc.filename).length
    };
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
                            <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200">
                                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                    <CardTitle className="text-sm font-semibold text-blue-900">Total Documents</CardTitle>
                                    <FileText className="h-5 w-5 text-blue-600" />
                                </CardHeader>
                                <CardContent>
                                    <div className="text-3xl font-bold text-blue-900">{stats.total}</div>
                                    <p className="text-sm text-blue-700">All documents</p>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="bg-gradient-to-br from-emerald-50 to-emerald-100 border-emerald-200">
                                ...
                                <CardContent>
                                    ...
                                    <p className="text-sm text-emerald-700">Successfully approved</p>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200">
                                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                    <CardTitle className="text-sm font-semibold text-purple-900">Uploaded</CardTitle>
                                    <Upload className="h-5 w-5 text-purple-600" />
                                </CardHeader>
                                <CardContent>
                                    <div className="text-3xl font-bold text-purple-900">{stats.uploaded}</div>
                                    <p className="text-sm text-purple-700">Files attached</p>
                                </CardContent>
                            </Card>
                        </div>
                                                    ...
                                                    <TableRow key={document.document_id} className="hover:bg-gray-50 transition-colors">
                                                        ...
                                                        <TableCell>
                                                            <div className="flex items-center space-x-3">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    {document.filename && (
                                                                        <p className="text-xs text-gray-500">File: {document.filename}</p>
                                                                    )}
                                                                </div>
                                                            </div>
                                                        </TableCell>
                                                        <TableCell>
                                                            <div className="max-w-xs">
                                                                <p className="text-gray-700 truncate" title={document.description}>
                                                                    {document.description}
                                                                </p>
                                                            </div>
                                                        </TableCell>
                                                                    ...
                                                                    <div className="flex items-center space-x-2">
                                                                        ...
                                                                        <div className="relative">
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <span>{document.filename ? 'Replace' : 'Upload'}</span>
                                                                            </Button>
                                                                        </div>
                                                                    </div>
                                                                )}
            ...
            <BigDialog open={open} onClose={() => setOpen(false)} width={'38'}>
                <div className="p-6">
                    <div className="text-center mb-6">
                        ...
                        <p className="text-gray-600 mt-2">Create a new document request for your client</p>
                    </div>
                    ...
                    <form className="space-y-6" onSubmit={handleDocumentRequest}>
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea
                                id="description"
                                name="description"
                                placeholder="Provide a detailed description of the document requirements..."
                                value={formdata.description}
                                onChange={handleFormChange}
                                required
                                rows={4}
