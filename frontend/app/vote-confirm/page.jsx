    ...
    switch (vote) {
      case 'SCHEDULED':
        return {
          ...
          message: 'The meeting has been successfully scheduled. All participants will be notified.',
      ...
      case 'CANCELED':
        return {
          ...
          message: 'The meeting has been canceled. All participants will be notified.',
