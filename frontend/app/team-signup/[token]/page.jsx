...
import { teamSignupRequest } from '@/lib/http/auth';
...
const TeamSignupPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await teamSignupRequest({
                token: params.token,
                name: formData.name,
                ...
                <Card className="w-full max-w-md">
                    <CardContent className="flex flex-col items-center justify-center p-8">
                        ...
                        <p className="text-gray-500 text-center">
                            Please wait while we create your team account.
                        </p>
                    </CardContent>
                </Card>
            </div>
            ...
            <div className="min-h-screen flex items-center justify-center bg-gray-50">
                <Card className="w-full max-w-md">
                    <CardContent className="flex flex-col items-center justify-center p-8">
                        ...
                        <p className="text-gray-500 text-center mb-6">
                            Your account has been created successfully! You can now login and access the platform.
                        </p>
