            ...
            <div className="grid p-2 grid-cols-2 gap-8">
                <div className="space-y-2">
                    <div className="bg-slate-50 border border-slate-200 p-2 rounded-lg">
                        ...
                        <div className="font-semibold text-slate-900">{selectedCase.name || 'N/A'}</div>
                    </div>
                    ...
                    <div className="bg-blue-50 border border-blue-200 p-2 rounded-lg">
                        ...
                        <div className="font-semibold text-blue-900">{selectedCase.client_name || 'N/A'}</div>
                    </div>
                    ...
                    <div className="bg-green-50 border border-green-200 p-2 rounded-lg">
                        ...
                        <div className="font-semibold text-green-900">{selectedCase.filingDate ? selectedCase.filingDate.split('T')[0] : 'N/A'}</div>
                    </div>
                    ...
                    <div className="bg-amber-50 border border-amber-200 p-2 rounded-lg">
                        ...
                        <div className="font-medium text-amber-900 text-sm leading-relaxed">{selectedCase.description || 'N/A'}</div>
                    </div>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <div className="bg-rose-50 border border-rose-200 p-2 rounded-lg">
                        ...
                        <div className="font-semibold text-rose-900">{selectedCase.opposing || 'N/A'}</div>
                    </div>
                    ...
                    <div className="bg-white border border-slate-200 p-2 rounded-lg">
                        ...
                        <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold border `}>
                            {selectedCase.client_address || 'N/A'}
                        </div>
                    </div>
                </div>
            </div>
