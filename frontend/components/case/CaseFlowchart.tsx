...
const TaskTimelineModal: React.FC<{
  ...
  const createTaskTimeline = () => {
    ...
    let sortedTimeline = timeline.sort((a, b) => new Date(b.created_at).getTime() - new Date(a.created_at).getTime());
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {event.hasAttachment && event.attachmentUrl && (
                          <div className="flex gap-2">
                            <button
                              onClick={() => viewFile(event.attachmentUrl, event.attachmentName)}
