    ...
    return (
      <div key={item.name}>
        ...
        >
          ...
          {!isFolder && <div className="w-6 mr-2" />}
    ...
    <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
      ...
      <div className="border-b border-gray-200 p-4">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-lg font-semibold text-gray-900">File Explorer (React Icons)</h2>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <div className="flex items-center space-x-1 border border-gray-200 rounded">
              ...
              >
                <FiMenu className="w-4 h-4 text-gray-500" />
              </button>
              <button 
...
export default ReactIconsFileExplorer;
